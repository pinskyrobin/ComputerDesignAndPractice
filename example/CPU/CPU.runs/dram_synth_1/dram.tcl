...
read_ip -quiet D:/CPU/CPU.srcs/sources_1/ip/dram/dram.xci
set_property used_in_implementation false [get_files -all d:/CPU/CPU.srcs/sources_1/ip/dram/dram_ooc.xdc]
...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/CPU/CPU.runs/dram_synth_1 -new_name dram -ip [get_ips dram]]
...
if { [catch {
  file copy -force D:/CPU/CPU.runs/dram_synth_1/dram.dcp D:/CPU/CPU.srcs/sources_1/ip/dram/dram.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim D:/CPU/CPU.srcs/sources_1/ip/dram/dram_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim D:/CPU/CPU.srcs/sources_1/ip/dram/dram_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/CPU/CPU.runs/dram_synth_1/dram_stub.v D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/CPU/CPU.runs/dram_synth_1/dram_stub.vhdl D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/CPU/CPU.runs/dram_synth_1/dram_sim_netlist.v D:/CPU/CPU.srcs/sources_1/ip/dram/dram_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/CPU/CPU.runs/dram_synth_1/dram_sim_netlist.vhdl D:/CPU/CPU.srcs/sources_1/ip/dram/dram_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/CPU/CPU.ip_user_files/ip/dram]} {
  catch { 
    file copy -force D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.v D:/CPU/CPU.ip_user_files/ip/dram
  }
}

if {[file isdir D:/CPU/CPU.ip_user_files/ip/dram]} {
  catch { 
    file copy -force D:/CPU/CPU.srcs/sources_1/ip/dram/dram_stub.vhdl D:/CPU/CPU.ip_user_files/ip/dram
  }
}
