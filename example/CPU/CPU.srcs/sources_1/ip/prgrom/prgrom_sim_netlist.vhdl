...
-- Date        : Mon Jul  5 09:46:32 2021
-- Host        : 614-17 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim F:/CPU_RISC_V/CPU/CPU.srcs/sources_1/ip/prgrom/prgrom_sim_netlist.vhdl
-- Design      : prgrom
...
architecture STRUCTURE of prgrom_rom is
  ...
  attribute SOFT_HLUTNM of \spo[23]_INST_0_i_1\ : label is "soft_lutpair3";
...
\synth_options.dist_mem_inst\: entity work.prgrom_dist_mem_gen_v8_0_12_synth
     port map (
      a(13 downto 0) => a(13 downto 0),
      spo(24 downto 23) => \^spo\(31 downto 30),
      spo(22) => \^spo\(26),
      spo(21 downto 17) => \^spo\(24 downto 20),
      spo(16) => \^spo\(2),
      spo(15 downto 1) => \^spo\(18 downto 4),
      spo(0) => \^spo\(1)
    );
end STRUCTURE;
library IEEE;
