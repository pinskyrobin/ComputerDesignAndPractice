...
always @ (*) begin
    case (led_cnt)
        3'h7 : led_display = PC[3:0];
        3'h6 : led_display = PC[7:4];
        3'h5 : led_display = PC[11:8];
        3'h4 : led_display = PC[15:12]; 
        3'h3 : led_display = PC[19:16];
        3'h2 : led_display = PC[23:20];
        3'h1 : led_display = PC[27:24];
        3'h0 : led_display = PC[31:28];
